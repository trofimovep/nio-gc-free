...
public class AllocationTracker {
    ...
    public static String getAllocationsInfo() {
        ...
        .append("Strings: ").append(stringAmount).append("\n")
        .append("Integer(int): ").append(intAmount).append("\n")
        .append("Byte(byte): ").append(byteAmount).append("\n")
        .append("Character(char): ").append(charAmount).append("\n")
        .append("Long(long): ").append(longAmount).append("\n")
